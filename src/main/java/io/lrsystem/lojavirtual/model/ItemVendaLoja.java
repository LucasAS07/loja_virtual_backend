...
public class ItemVendaLoja {
    ...
    private VndCompLjVirtual vendaCompraLjVirtual;
    ...
    public VndCompLjVirtual getVendaCompraLjVirtual() {
        return vendaCompraLjVirtual;
    }

    public void setVendaCompraLjVirtual(VndCompLjVirtual vendaCompraLjVirtual) {
        this.vendaCompraLjVirtual = vendaCompraLjVirtual;
    }
