...
public class NotaItemProduto {
    ...
    @ManyToOne
    @JoinColumn(name = "nota_fiscal_compra_id", nullable = false, foreignKey = @ForeignKey
            (value = ConstraintMode.CONSTRAINT, name = "nota_fiscal_compra_fk"))
    private NotaFiscalCompra notaCompra;
    ...
    public NotaFiscalCompra getNotaCompra() {
        return notaCompra;
    }

    public void setNotaCompra(NotaFiscalCompra notaCompra) {
